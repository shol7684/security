...
<body>
  ...
  <main id="profile">
    <div class="profile__photo-grid">
		...
		<div class="profile__photo_row">
			<div class="profile__photo">
				<a href="image-detail.html">
					<img alt="/image" src="/images/010c446b-ffdf-4a1c-a38b-e941e32f278d_boyoung.jpg">
					<div class="profile__photo-overlay">
						<span class="profile__photo-stat"> <i class="fa fa-heart"></i> 123</span> 
						<span class="profile__photo-stat"> <i class="fa fa-comment"></i> 22</span>
					</div>
				</a>
			</div>
