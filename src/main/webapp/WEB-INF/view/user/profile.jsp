		...
		<header class="profile__header">
			...
			<div class="profile__info">
						...
						<div id="follow_check">
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<button onClick="follow(true, 1)" class="profile_follow_btn">팔로우</button>
				...
				<ul class="profile__stats">
					...
					<li class="profile__stat"><span class="profile__stat-number">${followCount} </span><a href="/follow/follow/1">팔로우</a></li>
				</ul>
